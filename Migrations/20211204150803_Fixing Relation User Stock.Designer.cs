...
namespace Snap_n_go.Migrations
{
    ...
    [Migration("20211204150803_Fixing Relation User Stock")]
    partial class FixingRelationUserStock
    {
            ...
            modelBuilder.Entity("Snap_n_go.Models.History", b =>
                {
                    ...
                    b.Property<int?>("ScannedObjectId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ScannedObjectId");
